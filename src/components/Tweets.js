    ...
    <div className="main">
      <header className="head">
        <div className="dp">
          <img
            className="dpInside"
            src="https://pbs.twimg.com/profile_images/1250998688891068421/dWsez82E_200x200.jpg"
            alt=""
          />
        </div>
        <div className="content">
          <div className="contentHeader">
            Prakash Agrahari @PrakashAgrahar3 · Feb 19, 2020
          </div>
          <div className="mainContent">
            मुस्कुराते हुए ये होठ मेरे, और इनमें दफ्न हज़ार ख़ामोश कहानियां।
            आपने तो बस हाल पूछा था हमारा, लो हम ज़िन्दगी सुना गए अपनी !
          </div>
        </div>
      </header>
      <div className="border">
        <div className="picture">
          <img
            src="https://pbs.twimg.com/card_img/1409417916315885572/u_qK3EoE?format=jpg&name=small"
            alt=""
          />
        </div>
